                ...
                <div class="content-wrapper">
                    <form action="{{url('add_artikel')}}" method="post" class="mb-5" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" style="background-color: white !important; color: black !important;" class="form-control" id="ringkasan" name="ringkasan" placeholder="masukkan-ringkasan" required value="">
                        </div>
                        <div class="mb-3">
