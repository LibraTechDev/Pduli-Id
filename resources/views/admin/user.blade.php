                    ...
                    <form action="{{ url('add_user') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input style="background-color: white !important; color: black!important;" type="text"
                                class="form-control" id="name" name="name" placeholder="Masukan Judul" required
                                value="">
                        </div>
                        <div class="mb-3">
                            <label for="nik" class="form-label">NIK</label>
                            <input type="number" style="background-color: white !important; color: black!important;"
                                class="form-control" id="nik" name="nik" placeholder="Masukkan Nik" required
                                value="">
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="text" style="background-color: white !important; color: black!important;"
                                class="form-control" id="password" name="password" placeholder="Masukkan Password"
                                required value="">
                        </div>
